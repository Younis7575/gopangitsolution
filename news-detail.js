...
async function loadDetail() {
	try {
		...
		detailRoot.innerHTML = '<div class="gis-news-empty"><h3>Unable to load article.</h3><p>' + escapeHtml(error.message) + '</p><a href="news.html" class="theme-btn">Back to News</a></div>';
	}
}
